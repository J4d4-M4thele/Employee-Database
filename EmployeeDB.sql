...
VALUES
('Finance', 'Sharonlee'),--dept id 1
('Project Management', 'Bryanston'),--dept id 2
('Marketing', 'Douglasdale'),--dept id 3
('HR', 'Northwold');--dept id 4
...
VALUES
('Accounting'),--role id 1
('Projects'),--role id 2
('Advertising'),--role id 3
('Recruitment');--role id 4
